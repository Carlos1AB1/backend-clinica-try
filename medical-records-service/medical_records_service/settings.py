...
SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', 'django-insecure-medical-records-service-key')
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'medical_records_db'),
        'USER': os.getenv('DB_USER', 'medical_user'),
        'PASSWORD': os.getenv('DB_PASSWORD', 'medical_password'),
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'medical_records_service.authentication.JWTAuthentication',
    ),
